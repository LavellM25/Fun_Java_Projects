...
public class Dog {
    ...
    // Step 1: Declare an attribute 'name' for the Dog class to store the dog's name
    String name;
    ...
    public static void main(String[] args) {
        ...
        // Step 4: Create the first object of the Dog class and assign it to the reference variable 'dog1'
        Dog dog1 = new Dog();
        // At this point, dog1 is a Dog object, but its 'name' attribute is still null.

        // Step 5: Assign the value "Buddy" to the 'name' attribute of dog1
        dog1.name = "Buddy";
        // Now, dog1 has a name: "Buddy"

        // Step 6: Create the second object of the Dog class and assign it to the reference variable 'dog2'
        Dog dog2 = new Dog();
        // dog2 is another Dog object, separate from dog1.
